...
func (c *addServiceClient) AddMethod(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
	err := c.cc.Invoke(ctx, "/ADD.AddService/AddMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAddServiceServer) AddMethod(context.Context, *AddRequest) (*AddResponse, error) {
...
func _AddService_AddMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServiceServer).AddMethod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ADD.AddService/AddMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).AddMethod(ctx, req.(*AddRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AddService_AddMethod_Handler,
		},
	},
